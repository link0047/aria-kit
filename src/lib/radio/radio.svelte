...
<label class="radio" id="{labelId}" for="{id}">
  <input class="radio__native-control" id="{id}" name="exerciserequest" required="{required || undefined}" type="radio" value="{value}" aria-checked="{checked}" aria-labelledby="{labelId}">
